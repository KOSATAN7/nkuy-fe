...
import React from 'react';
  ...
  const VenueCardLanscape: React.FC<VenueCardLanscapeProps> = ({ venue }) => {
      ...
      function handleHeartClick(event: React.MouseEvent<SVGElement, MouseEvent>): void {
    ...
    return (
        <div className="relative w-64 h-40 bg-white shadow-lg rounded-2xl overflow-hidden flex transition-transform duration-300 hover:scale-105 cursor-pointer">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-transparent p-4 flex flex-col justify-end text-white">
            ...
            <div className="flex justify-between items-center">
              <Rating value={Number(venue.rating)} precision={0.5} readOnly sx={{ color: "#FFD700", fontSize: "1rem" }} />
              <FaHeart
